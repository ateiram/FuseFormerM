...
def main_worker():
    ...
    for video_no in range(video_num):
        ...
        for f in range(video_length):
            ...
            ssim += skimage.metrics.structural_similarity(comp, gt, data_range=255, multichannel=True, win_size=65)
            s_psnr += skimage.metrics.peak_signal_noise_ratio(gt, comp, data_range=255)
